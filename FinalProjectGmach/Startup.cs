...
namespace FinalProjectGmach
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddScoped(typeof(IpaymentTypeBl), typeof(paymentTypeBl));
            services.AddScoped(typeof(IpaymentTypeDl), typeof(paymentTypeDl));
            ...
            services.AddScoped(typeof(IWarningDl), typeof(WarningDl));
            services.AddDbContext<gmach277Context>(Options => Options.UseSqlServer(Configuration.GetConnectionString("MySiteDB")));
